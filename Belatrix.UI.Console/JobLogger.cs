...
namespace Belatrix.UI.Console
{
    ...
    logMessage, bool logWarning, bool logError)
        ...
        public static void LogMessage(string message, bool ValueMessage, bool warning, bool
    error)
        {
            message.Trim();
            ...
            if ((!_logError && !_logMessage && !_logWarning) || (!ValueMessage && !warning
    && !error))
            {
